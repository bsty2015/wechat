package com.example.bsty.wechat.fx.others;
...
import com.example.bsty.wechat.db.DbOpenHelper;
...
public class TopUserDao {
     ...
     * @param contactList
     */
    public void saveToUserList(List<TopUser> contactList) {
    ...
    public Map<String, TopUser> getTopUserList() {
        ...
        if (db.isOpen()) {
            Cursor cursor = db.rawQuery("select * from " + TABLE_NAME + " order by time asc ", null);
            while (cursor.moveToNext()) {
                ...
                int is_group = cursor.getInt(cursor.getColumnIndex(COLUMN_NAME_IS_GOUP));
